...
const testnetChains = [junotestnet, injectivetestnet, neutrontestnet, stargazetestnet];

export const chains = process.env.NEXT_PUBLIC_NETWORK === "TESTNET" ? testnetChains : [];
